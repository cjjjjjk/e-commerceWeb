...
function Women(){
    ...
    return (
        ...
        <div className="home-container h-100">
            <FullContent title="bộ sưu tập xuân/hè" des='Trang phục thiết yêu cho cuộc sống hiện đại' price='Chỉ từ: 350,000đ' image='https://im.uniqlo.com/global-cms/spa/res7fa45af738dac6c30bbaf4a275852a6afr.jpg'></FullContent>
            <div>
                <h2 className="p-4">HÀNG MỚI VỀ</h2>
                <div className="flex-container m-4 gap-4 d-flex flex-row">
            ...
            <FullContent title="MỪNG NGÀY QUỐC TẾ PHỤ NỮ" des='Trang phục hiện đại, trẻ trung phái đẹp' image='https://im.uniqlo.com/global-cms/spa/resfa01e6896858ad4ddae21ef83d6da147fr.jpg'></FullContent>
